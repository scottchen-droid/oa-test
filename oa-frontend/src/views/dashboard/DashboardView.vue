...
import UserLoginInfoCard from './components/UserLoginInfoCard.vue'
...
const mockShortcuts: ShortcutItem[] = [
  { id: 'notifications', name: '通知', icon: 'Bell', route: '/notifications', badgeCount: 0 },
  { id: 'approvals', name: '簽核', icon: 'Check', route: '/approvals', badgeCount: 0 },
  { id: 'leaves', name: '請假', icon: 'Calendar', route: '/leaves', badgeCount: 0 },
  { id: 'announcements', name: '公告', icon: 'Notification', route: '/announcements', badgeCount: 0 },
  { id: 'attendance', name: '考勤', icon: 'Clock', route: '/attendance', badgeCount: 0 },
]
